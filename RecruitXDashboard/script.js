...
const jobPostings = async () => {
  ...
  // Initial data fetch
  fetchJobData();
  // Check if URL has a parameter to show the secondary section
  // const params = new URLSearchParams(window.location.search);
  // if (params.get("show") === "secondary") {
  //     showSecondarySection(); // Function to toggle to the secondary section
  // }
};
